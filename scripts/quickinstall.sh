...
sudo env PATH=$PATH ansible-pull -U https://github.com/ansible-used-roles/ansible-role-landir.fonts -d /etc/ansible/roles/ansible-role-landir.fonts -i scripts/localinventory default.yml
